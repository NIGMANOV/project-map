...
const Search = () => {
  ...
  const [btnCategoryHistoric, setbtnCategoryHistoric] = useState(false);
  const [btnCategoryNatural, setbtnCategoryNatural] = useState(false);
  const [btnCategoryFood, setbtnCategoryFood] = useState(false);

  return (
    <>
      <div
        className={
          btnCategoryHistoric || btnCategoryNatural || btnCategoryFood
            ? "main main--active"
            : "main"
        }
      >
